...
const  Palakad =() => {
  ...
  return (
    ...
    <div className='d-flex justify-content-center align-items-center bg-dark' id='background'>
    ...
    <h1 className='text-center text-primary-emphasis'>Weather-App</h1>
        ...
        <div>
           ...
           <div className='text-center d-flex justify-content-center align-items-center mt-5 p-5'>
            <div className=' border border-primary-subtle p-5 rounded-circle' id='sunrise'><span className='text-warning fw-bolder '>
              Sunrise </span><br></br> <span className='fw-bolder'>{new Date(Details.sys.sunrise * 1000).toLocaleTimeString()}</span></div>
            <div className='border border-primary-subtle p-5 ms-5 rounded-circle' id='sunset'><span className='text-warning fw-bolder'>
              Sunset
              </span ><br>
